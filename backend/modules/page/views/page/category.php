    ...
    <div class="row">
        <div class="container-fluid">
            <div class="btn-group dropup">
                <?= Html::a('<i class="fa fa-reply"></i> &nbsp;Назад к новостям', Url::home() . 'page/page/index', ['class' => 'btn btn-default']) ?>
            </div>
        </div>
    </div>
    <br>
        ...
        <div class="container-fluid">
            <?php
                ...
                echo TreeView::widget([
	                ...
	                'nodeAddlViews' => [
		                Module::VIEW_PART_2 => '@backend/modules/page/views/default/element'
	                ]
                ]);
            ?>
        </div>
