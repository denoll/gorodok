...
<div class="auto-item-form">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				<div class="col-sm-3">
					<?= $form->field($model, 'status')->dropDownList(\common\models\auto\Arrays::statusAuto()) ?>
				</div>
				<div class="col-sm-9">
					<?= $form->field($model, 'id_user')->dropDownList(\common\models\auto\Arrays::usersAuto(),['prompt'=>'Пользователь ...']) ?>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-3">
	...
	<div class="form-group">
		<?= \common\widgets\buttons\ViewButtons::widget(['delete_url' => '/auto/item/delete-item','id' => $model->id]); ?>
	</div>
