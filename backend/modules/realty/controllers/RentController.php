...
use app\modules\realty\models\SearchRent;
use yii\helpers\Url;
...
/**
 * RentController implements the CRUD actions for RealtyRent model.
 */
class RentController extends Controller
{
    ...
    /**
     * Lists all RealtyRent models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchRent();
    ...
    /**
     * Displays a single RealtyRent model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RealtyRent model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RealtyRent();
        $post = Yii::$app->request->post();
        if ( $model->load($post)) {
            if(empty($post['RealtyRent']['id_user'])){
    ...
    /**
     * Updates an existing RealtyRent model.
    ...
    /**
     * Deletes an existing RealtyRent model.
    ...
    /**
     * Finds the RealtyRent model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RealtyRent the loaded model
