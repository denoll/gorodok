...
/**
 * SearchRent represents the model behind the search form about `common\models\realty\RealtyRent`.
 *
 * @param string $category
 * @param string $username
 */
class SearchRent extends VbRealtyRent
{
	/**
	 * @inheritdoc
	 */
