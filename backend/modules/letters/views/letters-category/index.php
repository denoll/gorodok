<?php
    ...
    $this->title = 'Категории коллективных писем';
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="btn-group dropup">
                <?= Html::a('<i class="fa fa-reply"></i> &nbsp;Назад к письмам',[ Url::to('/letters/letters/index')], ['class' => 'btn btn-default']) ?>
            </div>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="container-fluid">
            ...
            <?= TreeView::widget([
	            ...
	            'nodeAddlViews' => [
		            Module::VIEW_PART_2 => '@backend/modules/letters/views/letters-category/element'
	            ]
            ]); ?>
        </div>
    </div>
