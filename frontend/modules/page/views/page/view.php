...
$this->params['breadcrumbs'][] = ['label' => 'Статьи', 'url' => [Url::to('/page/page/index')]];
if(!empty($parent_cat)){
    foreach($parent_cat as $cat){
        $this->params['breadcrumbs'][] = ['label' => $cat['name'], 'url' => [Url::to('/page/page/index'), 'cat'=>$cat['alias']]];
    }
}
$this->params['breadcrumbs'][] = ['label' => $cur_cat['name'], 'url' => [Url::to('/page/page/index'), 'cat'=>$cur_cat['alias']]];
...
<div class="page-view">
    <div class="row">
        <div class="col-sm-12">
            ...
            <p><i class="small-text">Дата статьи:&nbsp;<?= \Yii::$app->formatter->asDate($model['modifyed_at'], 'long') ?></i>
