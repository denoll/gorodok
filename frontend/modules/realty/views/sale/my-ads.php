                ...
                <?php foreach ($model as $item) { ?>
                    <div class="inner-results">
                        ...
                        <div class="" style="margin: 5px 0px;">
                            ...
                            ?>
                            <?php
                            echo Html::a('Редактировать', ['/realty/sale/update', 'id' => $item['id']], ['class' => 'btn-u btn-u-sm  btn-u-default']);
                            echo Html::a('Удалить', ['/realty/sale/delete', 'id' => $item['id']], ['class' => 'btn-u btn-u-sm  btn-u-danger', 'data' => [
