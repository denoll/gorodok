...
$this->title = 'Расписание самолетов';
//$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['suburban']];
$this->params['breadcrumbs'][] = $this->title;
$m_d = 'Расписание самолетов города Тынды';
$m_k = 'расписание самолетов города Тынды, расписание самолетов';
if (!empty($m_d)) {
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i>Аэропорт: </i> <strong><?= $station[ 'title' ] ?></strong> - <i> На дату:</i> <?= Yii::$app->formatter->asDate($date) ?>
					</h3>
				</div>
