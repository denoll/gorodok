...
$this->title = 'Расписание электричек';
//$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['suburban']];
$this->params['breadcrumbs'][] = $this->title;
$m_d = 'Расписание электричек города Тынды';
$m_k = 'расписание электричек города Тынды, расписание электричек';
if (!empty($m_d)) {
		...
		foreach ( $list[ 'stations' ] as $station ) {
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<?php
					$stat = $schedule->setRequest($station[ 'code' ], $date, 'suburban');
